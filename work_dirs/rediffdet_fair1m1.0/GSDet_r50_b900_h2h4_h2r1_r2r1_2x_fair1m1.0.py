...
hbox2rbox = 1
launcher = 'none'
load_from = 'work_dirs/rediffdet_fair1m1.0/epoch_29.pth'
log_level = 'INFO'
...
num_proposals = 900
optim_wrapper = dict(
    clip_grad=dict(max_norm=35, norm_type=2, type='norm'),
    optimizer=dict(lr=3e-06, type='AdamW', weight_decay=0.0001),
    type='OptimWrapper')
...
work_dir = 'work_dirs/rediffdet_fair1m_final_sprint'
